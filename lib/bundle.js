(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("rxjsMap", [], factory);
	else if(typeof exports === 'object')
		exports["rxjsMap"] = factory();
	else
		root["rxjsMap"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(2),
	    leafletCss = __webpack_require__(6),
	    leafletJs = __webpack_require__(12);
	...
	document.addEventListener("DOMContentLoaded", function (event) {
	    ...
	    quakes.subscribe(function (quake) {
	        ...
	        Rx.DOM.mouseover(circle).subscribe(function (obj) {
	            L.popup().setLatLng([quake.lat, quake.lng]).setContent("At " + quake.place + "<br />" + "Magnitude: " + (quake.size / 10000).toString()).openOn(map);
	        });
	    });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)(module), (function() { return this; }()), __webpack_require__(5)))
